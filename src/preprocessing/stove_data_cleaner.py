"""Curatare date pentru dataset-ul sintetic de plite."""
...
INPUT_PATH = os.path.join("data", "generated", "stoves_dataset.csv")
OUTPUT_PATH = os.path.join("data", "processed", "stoves_clean.csv")
