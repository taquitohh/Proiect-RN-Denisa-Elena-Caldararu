...
INPUT_PATH = os.path.join("data", "processed", "fridges_scaled.csv")
TRAIN_DIR = os.path.join("data", "fridges", "train")
VAL_DIR = os.path.join("data", "fridges", "validation")
TEST_DIR = os.path.join("data", "fridges", "test")
