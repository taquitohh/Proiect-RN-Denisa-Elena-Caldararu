"""Curatare date pentru dataset-ul sintetic de mese."""
...
INPUT_PATH = os.path.join("data", "generated", "tables_dataset.csv")
OUTPUT_PATH = os.path.join("data", "processed", "tables_clean.csv")
