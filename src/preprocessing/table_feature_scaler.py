"""Scalare features pentru dataset-ul curatat de mese."""
...
INPUT_PATH = os.path.join("data", "processed", "tables_clean.csv")
OUTPUT_PATH = os.path.join("data", "processed", "tables_scaled.csv")
SCALER_PATH = os.path.join("config", "table_scaler.pkl")
