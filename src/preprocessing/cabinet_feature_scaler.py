"""Scalare features pentru dataset-ul curatat de dulapuri."""
...
INPUT_PATH = os.path.join("data", "processed", "cabinets_clean.csv")
OUTPUT_PATH = os.path.join("data", "processed", "cabinets_scaled.csv")
SCALER_PATH = os.path.join("config", "cabinet_scaler.pkl")
