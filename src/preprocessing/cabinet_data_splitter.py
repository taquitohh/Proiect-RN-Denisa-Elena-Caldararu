...
INPUT_PATH = os.path.join("data", "processed", "cabinets_scaled.csv")
TRAIN_DIR = os.path.join("data", "cabinets", "train")
VAL_DIR = os.path.join("data", "cabinets", "validation")
TEST_DIR = os.path.join("data", "cabinets", "test")
