"""Pipeline de antrenare pentru modelul de mese (Etapa 5.2)."""
...
MODEL_PATH = MODELS_DIR / "table_model.h5"
HISTORY_PATH = RESULTS_DIR / "table_training_history.csv"
METRICS_PATH = RESULTS_DIR / "table_training_metrics.json"
...
def train(epochs: int = 10, batch_size: int = 32) -> None:
    """Antreneaza modelul de mese si salveaza output-urile."""
